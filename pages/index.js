              ...
              <Stack direction="column" spacing="6">
                ...
                <Grid templateColumns="repeat(2, 1fr)" gap="20px">
                  ...
                  <Flex>
                    ...
                    <Text>Гарантированная безопасность</Text>
                  </Flex>
                  <Flex>
                    <Flex
                      alignItems="center"
                    ...
                    <Text>Уникальные возможности</Text>
                  </Flex>
                </Grid>
                <Text color="jashyl" lineHeight="tall">
                  Жилищный Кооператив Ихсан - это добровольное объединение
                  людей, с целью совместного удовлетворения потребностей членов
                  Кооператива в недвижимом имуществе и покупке жилья.
                </Text>
                <Heading as="h3" color="saryy" size="lg" fontWeight="500">
                  Гарант вашего дома!
                </Heading>
                <Text lineHeight="tall">
                  В нашем офисе Вас ждет полная консультация от наших
                  сотрудников о программах и условиях кооператива.
                </Text>
                <CustomButtonGreen>Узнать больше</CustomButtonGreen>
              </Stack>
            </Grid>
          </Container>
        </Box>
        ...
        <Box pb="100px">
          <Container maxW="container.xl">
            <Flex flexDir="column" alignItems="center">
              ...
              <CustomGrid mb="30px" />
              <CustomButtonGreen>Открыть весь список &#62;</CustomButtonGreen>
            </Flex>
          </Container>
        </Box>
        {/**---------------------- */}
...
const CustomTabs = () => {
  return (
    <Tabs orientation="vertical" variant="unstyled" w="full">
      <TabList>
        <CustomTab>&ldquo;Популярный&ldquo; 25 + 5</CustomTab>
        <CustomTab>&ldquo;Удобный&ldquo; 35 + 5</CustomTab>
        <CustomTab>&ldquo;Выгодный&ldquo; 50 + 5</CustomTab>
        <CustomTab>Без взноса +5</CustomTab>
        <CustomTab>Автомобиль</CustomTab>
      </TabList>
      <TabPanels border="1px solid" borderColor="jashyl" px="10">
